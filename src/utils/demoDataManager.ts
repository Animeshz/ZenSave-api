      ...
      CategoryService.createCategory(
        {
          ...
          status: ZENSAVE.CATEGORY_STATUS.ACTIVE,
      ...
      CategoryService.createCategory(
        {
          ...
          description: '',
          color_gradient: getRandomColorGradient(),
          status: ZENSAVE.CATEGORY_STATUS.INACTIVE,
          exclude_from_budgets: 0,
        },
        prismaTx
      )
      ...
      AccountService.createAccount(
        {
          ...
          type: ZENSAVE.ACCOUNT_TYPES.CHECKING,
          status: ZENSAVE.ACCOUNT_STATUS.ACTIVE,
          current_balance: 0,
          color_gradient: getRandomColorGradient(),
        },
        userId,
      ...
      AccountService.createAccount(
        {
          ...
          exclude_from_budgets: false,
          type: ZENSAVE.ACCOUNT_TYPES.SAVINGS,
          status: ZENSAVE.ACCOUNT_STATUS.ACTIVE,
          current_balance: 0,
          color_gradient: getRandomColorGradient(),
        },
      ...
      AccountService.createAccount(
        {
          ...
          exclude_from_budgets: false,
          type: ZENSAVE.ACCOUNT_TYPES.INVESTING,
          status: ZENSAVE.ACCOUNT_STATUS.ACTIVE,
          current_balance: 0,
          color_gradient: getRandomColorGradient(),
        },
      ...
      AccountService.createAccount(
        {
          ...
          type: ZENSAVE.ACCOUNT_TYPES.CREDIT,
          status: ZENSAVE.ACCOUNT_STATUS.ACTIVE,
          current_balance: 0,
          color_gradient: getRandomColorGradient(),
        },
    ...
    promises.push(
      prismaTx.transactions.create({
        data: {
          ...
          description: '',
          amount: 300_000_00,
          type: ZENSAVE.TRX_TYPES.EXPENSE,
          entities_entity_id: ENT_BANK1_ID,
    ...
    promises.push(
      prismaTx.transactions.create({
        data: {
          ...
          description: 'Savings',
          amount: 2_000_00,
          type: ZENSAVE.TRX_TYPES.TRANSFER,
          entities_entity_id: ENT_BANK1_ID,
  ...
  performDatabaseRequest(async (prismaTx) => {
    ...
    promises.push(
      RuleService.createRule(
        ...
        {
          users_user_id: userId,
          matcher_description_operator: ZENSAVE.RULES.OPERATOR.CONTAINS,
          matcher_description_value: 'wage',
          matcher_amount_operator: ZENSAVE.RULES.OPERATOR.EQUALS,
          matcher_amount_value: 3500_00,
          matcher_type_operator: ZENSAVE.RULES.OPERATOR.EQUALS,
          matcher_type_value: ZENSAVE.TRX_TYPES.INCOME,
          matcher_account_to_id_operator: ZENSAVE.RULES.OPERATOR.IGNORE,
          matcher_account_to_id_value: null,
          matcher_account_from_id_operator: ZENSAVE.RULES.OPERATOR.IGNORE,
    ...
    promises.push(
      RuleService.createRule(
        userId,
        {
          ...
          matcher_amount_operator: ZENSAVE.RULES.OPERATOR.IGNORE,
          matcher_amount_value: 0,
          matcher_type_operator: ZENSAVE.RULES.OPERATOR.IGNORE,
    ...
    promises.push(
      InvestAssetService.createAsset(
        userId,
        {
          ...
          ticker: 'HYSA',
          units: 0,
          type: ZENSAVE.INVEST.ASSET_TYPE.FIXED_INCOME,
          broker: 'BBank',
        },
        prismaTx
      )
    ...
    promises.push(
      InvestAssetService.createAsset(
        userId,
        {
          ...
          ticker: 'BTC',
          units: 0,
          type: ZENSAVE.INVEST.ASSET_TYPE.CRYPTO,
          broker: 'Binance',
        },
        prismaTx
      )
    ...
    promises.push(
      InvestAssetService.createAsset(
        userId,
        {
          ...
          ticker: 'VWCE',
          units: 0,
          type: ZENSAVE.INVEST.ASSET_TYPE.ETF,
          broker: 'DEGIRO',
        },
        prismaTx
      )
