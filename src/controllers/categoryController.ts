...
const createCategorySchema = joi.object({
  ...
  status: joi.string().valid(ZENSAVE.CATEGORY_STATUS.ACTIVE, ZENSAVE.CATEGORY_STATUS.INACTIVE),
...
const updateCategorySchema = joi.object({
  ...
  new_status: joi.string().valid(ZENSAVE.CATEGORY_STATUS.ACTIVE, ZENSAVE.CATEGORY_STATUS.INACTIVE),
