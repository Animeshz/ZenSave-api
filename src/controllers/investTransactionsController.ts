...
const createTransactionSchema = joi.object({
    ...
    type: joi.string().allow(ZENSAVE.INVEST.TRX_TYPE.BUY, ZENSAVE.INVEST.TRX_TYPE.SELL).required(),
    ...
    split_type: joi.string().allow(ZENSAVE.INVEST.TRX_TYPE.BUY, ZENSAVE.INVEST.TRX_TYPE.SELL, '').optional(),
});
...
const getFilteredTrxByPageSchema = joi.object({
    page_size: joi.number().default(ZENSAVE.DEFAULT_TRANSACTIONS_FETCH_LIMIT).min(1).max(300),
